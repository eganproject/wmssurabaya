...
use App\Http\Controllers\Admin\StockAsOfDateReportController;
...
Route::middleware(['auth', 'verified', 'menu.permission'])->prefix('admin')->as('admin.')->group(function () {
    ...
    Route::prefix('reports')->as('reports.')->group(function () {
        ...
        Route::get('/stock/movement-export', [StockReportController::class, 'movementExport'])->name('stock.movement-export');
