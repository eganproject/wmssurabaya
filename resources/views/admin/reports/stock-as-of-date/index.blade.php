...
<div class="card mb-6"><div class="card-body py-5">
    <div class="row g-3 align-items-end">
        ...
        <div class="col-xl-2 col-md-4"><label class="form-label">Status Produk Saat Ini</label><select id="filter_item_status" class="form-select form-select-solid"><option value="">Semua Produk</option><option value="1">Produk Aktif</option><option value="0">Produk Nonaktif</option></select></div>
...
document.addEventListener('DOMContentLoaded', () => {
    const filters = {date: document.getElementById('filter_date'), warehouse: document.getElementById('filter_warehouse'), category: document.getElementById('filter_category'), status: document.getElementById('filter_status'), itemStatus: document.getElementById('filter_item_status'), search: document.getElementById('filter_search')};
    ...
    [filters.date, filters.warehouse, filters.category, filters.status, filters.itemStatus].forEach(el => el.addEventListener('change', reload));
