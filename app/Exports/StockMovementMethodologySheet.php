...
class StockMovementMethodologySheet implements FromArray, WithStyles, WithTitle
{
    ...
    public function array(): array
    {
        return [
            ...
            ['Qty Keluar', 'Akumulasi outbound manual dan outbound import resi yang proses QC-nya berstatus selesai pada Gudang Besar + Gudang Kecil.', 'Mengukur permintaan aktual; proses resi yang belum selesai dan sumber mutasi lain tidak dihitung.'],
            ...
            ['Days Cover', 'Akumulasi stok Gudang Besar + Gudang Kecil dibagi rata-rata qty keluar per hari. Kosong jika tidak ada pergerakan.', 'Estimasi berapa hari total stok dapat memenuhi laju keluar historis.'],
